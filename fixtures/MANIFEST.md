...
500 m edge discard of 4 201 cells or 9.0%, and 5th/95th percentile ranking) it is
...
`mountain, mount` was returned and is not in the impervious list, so it is flagged as an
